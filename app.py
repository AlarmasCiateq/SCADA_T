...
<body>
    ...
    <script>
        ...
        // ========================================
        // CAMBIO CLAVE: Función limpiarUrl mejorada
        // ========================================
        function limpiarUrl(url) {
            if (!url) return null;
            // Trim agresivo + eliminar espacios al inicio y final + codificar solo espacios internos
            return url.trim().replace(/^\\s+|\\s+$/g, '').replace(/\\s+/g, '%20');
        }
